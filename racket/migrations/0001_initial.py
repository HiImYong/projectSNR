    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=100, verbose_name='라켓이름')),
                ('k_name', models.CharField(max_length=100, verbose_name='한국형이름')),
                ('weight', models.IntegerField(default=0, verbose_name='라켓무게')),
                ('pattern', models.CharField(max_length=100, verbose_name='라켓스트링패턴')),
                ('headsize', models.IntegerField(default=0, verbose_name='라켓헤드사이즈')),
                ('length', models.FloatField(default=0, verbose_name='라켓길이')),
                ('balance', models.CharField(default=0, max_length=20, verbose_name='라켓밸런스')),
                ('stiffness', models.IntegerField(default=0, verbose_name='라켓강성')),
                ('visitorAvgScore', models.FloatField(default=0, verbose_name='사용자평점평균')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('adminAvgScore', models.FloatField(default=0, verbose_name='운영자평점평균')),
        ...
        migrations.AddField(
            model_name='racket',
            name='brand',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='racket.racketbrand'),
        ),
        migrations.AddField(
            model_name='racket',
            name='like',
